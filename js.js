(function ($) {
	...
	FakePoller.prototype.getData = function() {
		...
		jQuery.ajax({
			url: "https://leaderboardi305845trial.hanatrial.ondemand.com/test/Leaderboard",		  
	...
	Leaderboard.prototype.buildElements = function($ul,elemSize){
		...
		function eventAnimationEnd (evt){
			...
			this.list[this.currentItem].$value.removeClass('red');
			this.list[this.currentItem].$value.removeClass('yellow');
			this.list[this.currentItem].$value.removeClass('blue');
			this.list[this.currentItem].$value.removeClass('green');
			
			if (_this.data[this.currentItem].color == "red"){
				this.list[this.currentItem].$value.addClass('red');
			}
			else if (_this.data[this.currentItem].color == "yellow"){
				this.list[this.currentItem].$value.addClass('yellow');
			}
			else if (_this.data[this.currentItem].color == "blue"){
				this.list[this.currentItem].$value.addClass('blue');
			}
			else if (_this.data[this.currentItem].color == "green"){
				this.list[this.currentItem].$value.addClass('green');
			}
